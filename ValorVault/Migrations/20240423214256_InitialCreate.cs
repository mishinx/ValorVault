        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    missing_place = table.Column<string>(type: "text", nullable: true),
                    death_place = table.Column<string>(type: "text", nullable: true),
                    profile_status = table.Column<string>(type: "text", nullable: false),
                    soldier_status = table.Column<string>(type: "text", nullable: false),
                    other_info = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_soldier_infos_AspNetRoles_admin_ref",
                        column: x => x.admin_ref,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_soldier_infos_AspNetUsers_user_ref",
                        column: x => x.user_ref,
                        principalTable: "AspNetUsers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
